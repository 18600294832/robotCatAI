export default {
  ...
  payment: {
    ...
    errors: {
      ...
      REFUND_FAILED: 'Refund failed.',
      PLAN_SOLD_OUT: 'This plan has reached its purchase limit.',
    },
    ...
    admin: {
      ...
      modelTagsHint: 'Click + to add more tags, e.g.: Claude, Gemini, Imagen',
      modelTagsPlaceholder: 'Enter model tag...',
      ...
      headcountLimit: 'Purchase Limit',
      headcountLimitPlaceholder: '0 = unlimited',
      headcountLimitHint: '0 = unlimited, > 0 = max number of active subscriptions',
      unlimited: 'Unlimited',
      soldOut: 'Sold Out',
