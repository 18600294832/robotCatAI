...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	paymentService := service.NewPaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, userSubscriptionRepository, affiliateService)
	...
	paymentHandler := admin.NewPaymentHandler(paymentService, paymentConfigService, userSubscriptionRepository)
	...
	handlerPaymentHandler := handler.NewPaymentHandler(paymentService, paymentConfigService, channelService, userSubscriptionRepository)
