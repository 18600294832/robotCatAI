...
// ByHeadcountLimit orders the results by the headcount_limit field.
func ByHeadcountLimit(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldHeadcountLimit, opts...).ToFunc()
}
