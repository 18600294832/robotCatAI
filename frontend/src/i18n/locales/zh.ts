export default {
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        platform: '平台',
        rateMultiplier: '费率倍数',
        extraRateMultiplier: '额外费率倍数',
        extraRateMultiplierPlaceholder: '0.0',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
      ...
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      extraRateMultiplierHint: '额外费率倍数，仅用于内部计费计算，不对客户端展示。实际费率 = 费率倍数 + 额外费率倍数。例如：费率倍数 1.0，额外费率倍数 0.2，实际计费使用 1.2，但对用户展示仍为 1.0',
      platforms: {
        all: '全部平台',
        anthropic: 'Anthropic',
        openai: 'OpenAI',
  ...
  payment: {
    ...
    admin: {
      ...
      modelTags: '模型标签',
      modelTagsHint: '点击 + 号添加更多标签，例如：Claude、Gemini、Imagen',
      modelTagsPlaceholder: '输入模型标签...',
      addModelTag: '添加模型标签',
      providerManagement: '服务商管理',
      providerManagementDesc: '管理支付服务商实例',
      ...
      groupMissing: '缺失',
      headcountLimit: '限购人数',
      headcountLimitPlaceholder: '0 表示不限购',
      headcountLimitHint: '0 表示不限购，大于 0 表示最多可售人数',
      unlimited: '不限购',
      soldOut: '已售罄',
      groupInfo: '分组信息',
      platform: '平台',
