...
func init() {
	...
	// groupDescExtraRateMultiplier is the schema descriptor for extra_rate_multiplier field.
	groupDescExtraRateMultiplier := groupFields[3].Descriptor()
	// group.DefaultExtraRateMultiplier holds the default value on creation for the extra_rate_multiplier field.
	group.DefaultExtraRateMultiplier = groupDescExtraRateMultiplier.Default.(float64)
	...
	// subscriptionplanDescHeadcountLimit is the schema descriptor for headcount_limit field.
